              ...
              <tbody className="divide-y divide-slate-50">
                ...
                {filteredAccounts.map((acc, idx) => (
                  <tr key={acc.id} ref={(el) => (rowRefs.current[idx] = el)} className="ua-row group transition-colors hover:bg-white">
                    ...
                    <td className="px-8 py-7">
                      <span className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-wider ${acc.status === 'Active' ? 'bg-emerald-50 text-emerald-600 ring-1 ring-emerald-200' :
              ...
              <div className="p-8 space-y-6 max-h-[75vh] overflow-y-auto no-scrollbar">
                ...
                <div className="grid grid-cols-2 gap-6 rounded-3xl bg-slate-50 p-6 border border-slate-100">
                  ...
                  <div>
                    ...
                    <span className={`mt-1 inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-wider ${accounts[viewingAccountIndex].status === 'Active' ? 'bg-emerald-50 text-emerald-600 ring-1 ring-emerald-200' :
